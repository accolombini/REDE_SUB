'''
    REDE_SUB.docx
        ...
        |> Objetivo: este script simples deve gerar uma base para estudos do projeto.
            O foco são gerar diferentes bases para atender ao Épico 2
'''
...
# Definir caminhos para as bases simuladas
...
output_csv = os.path.join(data_directory, "ep2_base_csv.csv")
output_xlsx = os.path.join(data_directory, "ep2_base_xlsx.xlsx")
output_json = os.path.join(data_directory, "ep2_base_json.json")
